...
class JoinRequestsList extends StatefulWidget {
  const JoinRequestsList({Key? key}) : super(key: key);

  @override
  _JoinRequestsListState createState() => _JoinRequestsListState();
}

class _JoinRequestsListState extends State<JoinRequestsList> {
  ...
  void initState() {
    _ascending = false;
    _sortColumnIndex = 0;
    _querySnapshot = _services.joinRequest.snapshots();
