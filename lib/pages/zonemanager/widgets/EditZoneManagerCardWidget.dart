...
class EditZoneManagerCardWidget extends StatefulWidget {

  const EditZoneManagerCardWidget({Key? key, required this.emailId}) : super(key: key);

  final String emailId;
  static const String id = 'editCoordniator-page';

  @override
  State<EditZoneManagerCardWidget> createState() => _EditZoneManagerCardWidgetState();
}

class _EditZoneManagerCardWidgetState extends State<EditZoneManagerCardWidget> {
  ...
  var _selectedGender;
  DroppedFile? coordinatorImageName;
  ...
  Widget build(BuildContext context) {
    ...
    return AdminScaffold(
        ...
        sideBar: _sideBar.sideBarMenus(context, ZoneManagerPage.id),
        body: Container(
                    ...
                    Row(
                      children: [
                        ElevatedButton.icon(
                          ...
                          onPressed: () {
                            Navigator.popAndPushNamed(context, ZoneManagerPage.id);
                          },
