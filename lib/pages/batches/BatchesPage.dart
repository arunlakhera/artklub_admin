...
import 'package:artklub_admin/pages/batches/widgets/CreateBatchesCardWidget.dart';
import 'package:artklub_admin/pages/batches/widgets/BatchesList.dart';
...
class BatchesPage extends StatefulWidget {
  ...
  static const String id = 'batches-page';
...
class _BatchesPageState extends State<BatchesPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return AdminScaffold(
        ...
        sideBar: _sideBar.sideBarMenus(context, BatchesPage.id,userType: ScreenArguments.userType),
        body: Container(
          ...
          child: Column(
            children: [
              HeaderWidget(title: 'Batches'),
              Divider(thickness: 5,),
              Visibility(
                visible: !_createFlag,
                child: _buildPageHeader('Create Batch'),
              ),
              Visibility(
                visible: _createFlag,
                child: _buildPageHeader('View All Batches'),
              ),
              Divider(thickness: 5),
