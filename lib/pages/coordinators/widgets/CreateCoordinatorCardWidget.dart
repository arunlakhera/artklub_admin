...
class CreateCoordinatorCardWidget extends StatefulWidget {
  const CreateCoordinatorCardWidget({Key? key}) : super(key: key);

  @override
  _CreateCoordinatorCardWidgetState createState() =>
      _CreateCoordinatorCardWidgetState();
}

enum Gender { Female, Male }

class _CreateCoordinatorCardWidgetState
    extends State<CreateCoordinatorCardWidget> {
